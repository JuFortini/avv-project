  ...
  return (
    <>
      <div className="bg-teal-50 px-8 lg:px-16 py-24 lg:py-2 h-svh w-full flex justify-center items-center">
        <div className="flex flex-col lg:flex-row justify-center items-center max-w-[30rem] lg:max-w-screen-xl h-full w-full sm:space-y-10 space-x-20">
          ...
          <div className="relative w-full lg:max-w-full max-w-[30rem] h-3/5 lg:h-4/5">
            <img
